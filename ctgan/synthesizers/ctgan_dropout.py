...
class Discriminator(Module):
    ...
    def __init__(self, input_dim, discriminator_dim, pac=10):
        ...
        for item in list(discriminator_dim):
            seq += [Linear(dim, item), LeakyReLU(0.2), Dropout(0.2)]
            dim = item
...
class Residual(Module):
    ...
    def __init__(self, i, o, mcd_prob):
...
class Generator(Module):
    ...
    def __init__(self, embedding_dim, generator_dim, data_dim, mcd_prob):
...
class CTGANSynthesizer(BaseSynthesizer):
    ...
    def sample(self, n, shift, shift_type=None, d_min=1, d_off=1, softness=1, mu_shift=0, std_shift=1, condition_column=None, condition_value=None, mcd=False):
        ...
        return self._transformer.inverse_transform(data), fakez
